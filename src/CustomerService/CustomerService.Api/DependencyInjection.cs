using CustomerService.Api.OpenApi.Transformers;
using CustomerService.Application;
using CustomerService.Features.Customers.Consumers;
...
{
    public static IServiceCollection AddCustomerServiceApplicationServices(this IServiceCollection services, IConfiguration configuration)
    {
        services
...
tags: new[] { "messagebroker", "critical" });
    ...
    private static IServiceCollection AddOpenTelemetryDistributedTracing(this IServiceCollection services)
    {
        services.AddOpenTelemetry()
                .ConfigureResource(res => res.AddService("customerservice"))
    .WithTracing(tracing =>
    {
    ...
    private static IServiceCollection AddMassTransitService(this IServiceCollection services)
    {
        services.AddMassTransit(x =>
        {
            ...
            // 2. Configure Outbox (Reliability)
            x.AddEntityFrameworkOutbox<CustomerDbContext>(o =>
            {
                o.UseSqlServer(); // Or UseNpgsql()

                // Use the Outbox to prevent duplicate processing
                o.UseBusOutbox();
            });
            ...
            x.UsingRabbitMq((context, cfg) =>
            {
                ...
                cfg.ReceiveEndpoint("customer-create-profile", e =>
                {
